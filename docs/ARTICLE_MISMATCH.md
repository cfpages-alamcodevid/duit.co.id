# ARTICLE_MISMATCH Log

Use this file to record article or research files that do not match `docs/ARTICLE_CATALOG.md`.

## Rules

- Append only. Never rewrite past entries.
- Do not delete article or research files because of a mismatch.
- Keep catalog edits separate and surgical.
...
| 2026-05-03 14:24 WIB | negosiasi-freelance | tier-1-hustler | research | Research file created for published article that previously had no research | None - research completed |
| 2026-05-03 14:45 WIB | ternak-ayam-kampung-organik | tier-1-hustler | catalog | Article status ✅ but no research file existed | Research completed, status updated to 📝 |
