---
name: mojibake-fixer
description: "Specialized for Gemini CLI: Detects and fixes mojibake characters (Chinese, Russian, Korean, Japanese, Arabic) in article files. Ensures clean Indonesian and English content only."
tools:
  - "write_file"
  - "read_file"
  - "glob"
...
Use `write_file` tool to replace the corrupted characters with correct Indonesian/English text.
