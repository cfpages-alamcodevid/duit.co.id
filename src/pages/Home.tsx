...
import { Shield, TrendingUp, Users, Landmark } from "lucide-react"
  ...
  <section className="relative py-20 px-4 overflow-hidden">
    <div className="max-w-7xl mx-auto text-center relative z-10">
      ...
      >
        ...
        <span className="text-moneyGreen">Build Your Sovereignty.</span>
      </motion.h1>
      <motion.p 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <Link to="/about" className="text-sm font-bold hover:underline">
    ...
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-moneyGreen/5 rounded-full blur-3xl -z-10" />
  </section>
)
  ...
  return (
    <section className="py-20 px-4">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold mb-12 text-center">Master the 5 Tiers of Wealth</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {tiers.map((tier, idx) => (
            <GlassCard key={idx} className="hover:scale-105 transition-transform cursor-default">
              <tier.icon className="w-12 h-12 text-moneyGreen mb-6" />
