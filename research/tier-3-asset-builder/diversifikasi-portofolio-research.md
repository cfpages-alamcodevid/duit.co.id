# Riset: Diversifikasi Portofolio untuk Pemilik Aset Riil

Date Prepared (WIB): 2026-04-19 21:43 WIB

## 1. Article Brief
Title: Diversifikasi Portofolio untuk Pemilik Aset Riil  
Slug: diversifikasi-portofolio  
Tier: tier-3-asset-builder  
Target Audience: Pemilik properti/bisnis yang terlalu terkonsentrasi  
Primary Category: keuangan  
Secondary Categories: investasi,manajemen-risiko  
...
Contoh math: portofolio Rp10 miliar terdiri dari 80% properti sewa, 20% kas. Rebalancing ke 50% properti, 20% obligasi, 20% saham/dividen, 10% kas dapat menurunkan drawdown likuiditas saat vacancy meningkat (Perlu verifikasi dampak historis).

## 8. Common Myths & Misconceptions
Mitos: Diversifikasi menurunkan return. Realita: Diversifikasi menurunkan risiko konsentrasi dan menjaga keberlanjutan arus kas.

## 9. Action Steps Outline
Langkah aksi: tetapkan batas maksimum per aset (mis. 40-50%), review kuartalan, rebalancing berbasis deviasi target 5%.
...
- H1: Diversifikasi Portofolio untuk Pemilik Aset Riil  
