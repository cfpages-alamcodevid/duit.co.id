...
- Export PNG/PDF langsung dari browser
- Bisa upload foto existing condition untuk tracing

**Kekurangan:**
- Tidak bisa export DWG (tapi client renov kecil tidak minta DWG)
- Plugin terbatas vs SketchUp Pro
...
- Command mirip AutoCAD (layer, dimension, hatch)
...
**Cukup untuk:** Shop drawing 2D, detail konstruksi, as-built drawing
...
- Client bisa lihat real-time via link
- Render interior cukup realistis

**Kekurangan:**
- Kurang fleksibel untuk custom shape
- Export HD butuh bayar
...
- Mudah update harga material
- Client familiar dengan format Excel

**Kekurangan:**
- Manual input volume
- Perlu template yang sudah jadi
...
|------|--------|--------|------------|
| **Pekerjaan Bongkar** | | | |
| Bongkar keramik dinding | 18 | m² | 4 sisi x 3m x 2m (tinggi) |
| Bongkar keramik lantai | 9 | m² | 3m x 3m |
| Bongkar closet + wastafel | 1 | ls | Lepas pasang |
| **Pekerjaan Pasang** | | | |
| Pasang keramik dinding | 18 | m² | Termasuk nat + lem |
| Pasang keramik lantai | 9 | m² | Anti-slip |
| Pasang closet duduk | 1 | unit | Termasuk pipa sambung |
| Pasang wastafel + kran | 1 | unit | |
| Pasang shower box | 1 | set | |
| Cat ceiling | 9 | m² | Anti-jamur |
| **Material** | | | |
| Keramik dinding 30x60 | 20 | dus | +10% waste |
| Keramik lantai 30x30 | 11 | dus | Anti-slip |
| Lem keramik | 4 | zak | |
| Nat keramik | 2 | kg | |
| Closet duduk + seat | 1 | set | |
| Wastafel + kran | 1 | set | |
| Shower box + mixer | 1 | set | |
| Cat ceiling anti-jamur | 5 | liter | 2 lapis |
| **Upah Tukang** | | | |
...
|----------|--------------|
| Keramik dinding 30x60 (per dus) | Rp 85.000 |
| Keramik lantai 30x30 anti-slip (per dus) | Rp 75.000 |
| Lem keramik (per zak 20kg) | Rp 65.000 |
| Nat keramik (per kg) | Rp 35.000 |
| Closet duduk American Standard | Rp 1.200.000 |
| Wastafel + kran mixer | Rp 450.000 |
...
Konfirmasi order jasa drafter + RAB:

Proyek: Renov kamar mandi 3x3m
Lokasi: [Alamat]
Harga jasa: Rp 750.000
DP 50%: Rp 375.000
Pelunasan: Setelah deliver final file
...
Mohon konfirmasi dengan reply "SETUJU".
...
Kalau sudah scale ke 10+ client/bulan, pertimbangkan asuransi profesional.

Produk: "Professional Indemnity Insurance"

Coverage:
- Kesalahan desain yang menyebabkan kerugian client
- Keterlambatan deliver
- Dispute kontrak

Premi: sekitar 1-2% dari revenue tahunan.

Kalau revenue Rp 60 juta/tahun, premi Rp 600.000-1,2 juta/tahun.
...
Client pertama: Rp 500.000 (untuk portfolio).

Client ke-10: Rp 600.000.

Client ke-20: Rp 750.000.
...
Single service: RAB saja Rp 400.000.

Bundle:
- RAB + 2D: Rp 600.000
- RAB + 2D + 3D: Rp 850.000
- RAB + 2D + 3D + Survey: Rp 1.200.000
...
Bayar per proyek: Rp 200.000-300.000/proyek.

Anda fokus client acquisition + quality control.

Junior drafter fokus production.
