...
Ini bagian paling penting. Dan paling sering disalahpahami.
...
**Yang ILEGAL: Resale Price Maintenance (RPM)**

Ini ketika Anda MEMAKSA reseller jual di harga tertentu. Dengan sanksi pemutusan kontrak jika melanggar.
...
Ini ketika Anda memberi REKOMENDASI harga. Tanpa sanksi pemutusan.

Contoh:

> "Harga jual yang kami rekomendasikan: Rp 150 ribu. Untuk iklan online, minimum advertised price: Rp 135 ribu."
...
Anda boleh beri exclusive territory ke Master Agen.

Contoh: "Agen exclusive untuk wilayah Kota Bandung."
...
Satu kesalahan yang sering dibuat: Semua reseller diperlakukan sama.

Padahal tidak semua reseller punya kapasitas sama.

Ada yang bisa beli stok Rp 50 juta per bulan. Ada yang cuma mampu Rp 5 juta.

Kalau disamakan margin-nya, yang kapasitas besar akan frustrasi. Yang kapasitas kecil akan kewalahan.

Solusinya: **Tier system.**

### Tier 1: Master Agen (Exclusive Territory)

**Kualifikasi:**
- Minimal order: Rp 25-50 juta per bulan
- Exclusive untuk kota/kabupaten tertentu
- Bisa rekrut sub-reseller di territory-nya
- Margin: 30-40% dari harga eceran

**Kewajiban:**
- Maintain stok minimum di gudang
...
- Dari penjualan langsung ke konsumen: Rp 25 ribu per unit
...
**Kualifikasi:**
- Minimal order: Rp 5-10 juta per bulan
- Tidak exclusive territory
- Hanya bisa jual di area yang ditentukan (tidak boleh cross-territory Master Agen lain)
- Margin: 15-25% dari harga eceran

**Kewajiban:**
- Tidak boleh supply ke reseller lain (hanya end consumer)
...
**Kualifikasi:**
- Tidak perlu stok
- Jual via marketplace/media sosial
- Order ke Master Agen/Sub-Reseller
- Margin: 10-15% dari harga eceran
...
```
PRODUK: Serum Wajah GlowUp 30ml
Harga Eceran Rekomendasi: Rp 150.000
Minimum Advertised Price: Rp 135.000
...
- ❌ Otomatis putus kontrak jika violate MAP
- ❌ Denda finansial
- ❌ Blokir akses ke produk tanpa warning

**Yang Boleh Dilakukan:**

- ✅ Tidak beri bonus loyalty bulan tersebut
- ✅ Tidak masuk leaderboard
...
Reseller A di Bandung. Reseller B di Jakarta.

Keduanya jual di Shopee. Konsumen bandingkan harga. Pilih yang murah.

Reseller A turun harga. Reseller B ikut turun.

Perang harga dimulai.

Dengan territory management:

Reseller A exclusive Bandung. Reseller B exclusive Jakarta.
...
2. **Video Pendek** (15-60 detik)
   - Unboxing video
   - Tutorial penggunaan
   - Testimoni customer (dengan izin)
...
5. **Marketing Kit**
   - Banner untuk marketplace
   - Logo untuk watermark
   - Template promo (misal: "Flash Sale 24 Jam")

**Contoh Paket yang Diberikan "GlowUp ID":**

```
PAKET RESELLER GLOWUP ID:

✓ 50 foto produk high-resolution
✓ 10 video Reels siap posting
✓ 20 caption Instagram (tinggal copy-paste)
✓ Script WhatsApp closing
✓ Akses grup Facebook private (sharing mingguan)
✓ Webinar bulanan dengan owner
...
```
Kepada: [Nama Reseller]
Dari: [Nama Owner/Account Manager]
Tanggal: [Tanggal]
Perihal: Reminder Pricing Policy
...
PIHAK PERTAMA (Pemberi Izin):
Nama: [Nama Owner/Perusahaan]
Alamat: [Alamat Lengkap]
No. KTP/NPWP: [Nomor]

PIHAK KEDUA (Penerima Izin):
Nama: [Nama Reseller]
Alamat: [Alamat Lengkap]
No. KTP/NPWP: [Nomor]
...
1. **Tentukan struktur tier**
   ...
   - Margin untuk masing-masing tier
   - Minimum/maximum order

2. **Buat pricing policy**
   - Harga eceran rekomendasi
   - MAP untuk marketplace
   - Graduated enforcement system
...
1. **Identifikasi kandidat**
   ...
   - Followers Instagram yang engaged
   - Referral dari network

2. **Screening**
   - Kapasitas modal (bisa order Rp 25-50 juta?)
   - Pengalaman jualan (punya network?)
   - Komitmen (full-time atau side hustle?)
...
1. **Master Agen rekrut di territory masing-masing**
   ...
   - Webinar bersama calon reseller

2. **Screening Sub-Reseller**
   - Kapasitas modal (Rp 5-10 juta)
   - Komitmen waktu
...
1. **Soft launch**
   ...
   - Owner monitor harga di marketplace

2. **Weekly check-in**
   - WA group: Update sales mingguan
   - Owner share tips closing
...
**Modal Awal Setup Jaringan Reseller:**

```
Item                          Biaya
--------------------------------------------
Initial inventory             Rp 15.000.000
(500 unit @ Rp 30rb untuk Master Agen)

Content asset production      Rp 5.000.000
(Foto profesional, video editor freelance)

Marketing rekrutmen           Rp 5.000.000
(FB Ads, Instagram Ads, webinar)

Legal (notaris kontrak)       Rp 2.000.000

Monitoring tools              Rp 1.000.000
(Google Workspace, Zapier)

Operating buffer              Rp 7.000.000
(3 bulan monitoring)
...
Sistem channel partner yang baik punya 5 pilar:

1. **Struktur tier jelas** — Master Agen dapat exclusive, Sub-Reseller dapat support
2. **Pricing guardrail legal** — MAP/HJR, bukan fix price yang melanggar KPPU
3. **Territory management** — Tidak ada cannibalization
4. **Stock policy** — Mencegah dumping karena over-stock
5. **Content asset + training** — Loyalty bukan cuma dari margin

Semua ini bisa dilakukan legal. Tidak perlu takut KPPU.

Yang penting: Bahasa yang digunakan adalah "rekomendasi", bukan "wajib". Sanksi yang diberikan adalah "tidak dapat bonus", bukan "putus kontrak".

**Action Steps untuk Anda:**

1. **Hari ini:** Tentukan struktur tier dan margin untuk masing-masing tier
2. **Minggu ini:** Buat pricing policy (MAP) dan draft kontrak
3. **2 minggu:** Produksi content asset (foto, video, copywriting)
4. **3 minggu:** Rekrut 3-5 Master Agen pertama (pilih yang paling loyal)
5. **4 minggu:** Launch, monitor, adjust

Jangan tunggu sempurna. Launch dulu. Learn sambil jalan.
