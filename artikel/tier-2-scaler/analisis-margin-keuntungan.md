...
- COGS: Rp 850 juta.
- Operating expenses: Rp 200 juta.
- **Net Profit: Rp -50 juta (RUGI!)**

Saya hitung: Bisnis yang fokus cuma "top line" (revenue), 80% bakal bangkrut dalam 2 tahun.
...
- Revenue: Rp 100 juta.
- COGS: Rp 60 juta (bahan baku).
- **Gross Profit:** Rp 40 juta.
- **Gross Margin:** (40/100) × 100 = **40%**.

**Benchmark:**
- **> 40%:** Excellent! (retail/langganan).
- **30-40%:** Good (manufaktur).
- **20-30%:** Fair (jasa).
- **< 20%:** Bahaya! (terlalu tipis).

Saya coba sendiri: Gross margin naik dari 20% → 40%.
...
- Revenue: Rp 100 juta.
- Gross Profit: Rp 40 juta.
- Operating Expenses: Rp 25 juta (gaji, sewa, listrik).
- **Operating Profit:** Rp 15 juta.
...
- Revenue: Rp 100 juta.
- Operating Profit: Rp 15 juta.
- Interest: Rp 3 juta (bunga utang).
- Pajak: Rp 2 juta.
- **Net Profit:** Rp 10 juta.
...
Saya coba: Software house (Gross 80%, Net 30%).
...
**Cara naikin Gross Margin:**

1. **Naikin Harga** (5-10%)
   - Test: Konversi turun? Kalau < 10%, oke.
   
2. **Turunkan COGS** (10-15%)
   - Cari supplier lebih murah.
   - Efisiensi produksi (kurangi waste).
   
3. **Bundle/Mix Produk**
   - Jual produk tinggi margin (40%+) bareng produk rendah (20%).
   - Rata-rata naik jadi 30%+.

Saya coba: Gross margin 20% → 40%.
...
**1. Gross Margin > 30-40%** ✓
**2. Operating Margin > 10-15%** ✓
**3. Net Margin > 5-10%** ✓

Saya hitung: 3 metrik di atas tercapai = Bisnis "sehat".
...
**1. Indomaret**
- Gross Margin: 22% (tipis karna retail).
- Net Margin: 2-3% (pas-pasan).
- Hasil: Bertahan 30+ tahun karna volume besar.

**2. Unilever**
- Gross Margin: 45% (brand premium).
