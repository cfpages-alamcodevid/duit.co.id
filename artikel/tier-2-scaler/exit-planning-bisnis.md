...
Padahal ndak ada yang "abadi".

Saya hitung: Bisnis tanpa exit plan, 80% gagal diturunkan ke generasi kedua.
...
### 1. Strategic Sale (Jual ke Kompetitor)
- **Kapan:** Mau "cair" (cash) secepatnya.
- **Pro:** Dapat full cash (Rp 5-10 miliar).
- **Kontra:** Kehilangan kendali (sudah bukan pemilik).

### 2. M&A (Merger & Akuisisi)
- **Kapan:** Mau gabung ke perusahaan lebih besar.
- **Pro:** Dapat saham (equity) + cash.
- **Kontra:** Still involved (harus bekerja 3-5 tahun).

### 3. IPO (Initial Public Offering)
- **Kapan:** Bisnis Rp 1 triliun+ (unicorn).
- **Pro:** Dana segar Rp 500 miliar - 1 triliun.
- **Kontra:** Transparansi penuh, audit ketat.

Saya sarankan: **Strategic Sale** kalau mau "cair" total.
...
```
Valuasi = Laba Bersih × Multiplier
```
- Laba: Rp 1 miliar/tahun.
- Multiplier: 10x (bisnis mature).
- **Valuasi:** Rp 1 miliar × 10 = **Rp 10 miliar**.

### 2. EBITDA Multiple
```
Valuasi = EBITDA × Multiplier
```
