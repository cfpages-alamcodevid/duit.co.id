...
Dokter cuma tanya: "Gimana rasanya?"
Anda jawab: "Sehat Pak."

Padahal aslinya kena diabet.

Buat ngecek kesehatan, perlu **pemeriksaan rutin**.

Sama dengan bisnis.

Perlu cek kesehatan finansial **sebulan sekali**.

Saya sarankan: Tanggal 1-5 tiap bulan.
...
- Total penjualan
- Total pengeluaran (operasional, gaji, sewa, dll)
- Laba bersih (Penjualan - Pengeluaran)

**2. Laporan Arus Kas (Cash Flow)**
- Kas masuk (dari mana? penjualan, piutang, dll)
- Kas keluar (bayar apa? supplier, gaji, pajak, dll)
- Saldo akhir

**3. Neraca (Balance Sheet)** - Opsional buat bisnis kecil
- Aset (kas, piutang, stok, aset tetap)
- Kewajiban (utang, hutang pajak)
- Modal (uang sendiri di bisnis)
...
```
GPM = ((Penjualan - HPP) / Penjualan) × 100
```

Contoh:
- Penjualan: Rp 100 juta
- HPP (bahan baku): Rp 60 juta
- Laba kotor: Rp 40 juta

GPM = ((100 - 60) / 100) × 100 = 40%

**Ideal:** Minimal 30-40% (tergantung jenis bisnis).

Saya lihat: GPM turun dari 40% ke 30%? Cek harga bahan baku. Apa naik? Atau harga jual turun?
...
### 3. Current Ratio (Rasio Likuiditas)
...
Contoh:
- Aset lancar (kas + piutang + stok): Rp 50 juta
- Kewajiban lancar (utang jatuh tempo <1 tahun): Rp 25 juta

CR = 50 / 25 = 2x

**Ideal:** Minimal 1,5 - 2x.

Saya hitung: CR < 1? Bahaya! Berarti utang jatuh tempo lebih besar dari kas tersedia.

### 4. Accounts Receivable Days (Hari Piutang)

```
ARD = (Piutang / Penjualan Kredit) × Jumlah Hari
```

Contoh:
- Piutang: Rp 30 juta
- Penjualan kredit: Rp 90 juta/bulan
- Hari dalam bulan: 30

ARD = (30 / 90) × 30 = 10 hari.

**Ideal:** Maksimal 30 hari (1 bulan).

Saya perhatikan: ARD > 45 hari? Banyak pelanggan "telat bayar". Perketat credit control.

### 5. Inventory Turnover (Perputaran Stok)

```
IT = Harga Pokok Penjualan / Rata-rata Stok
```

Contoh:
- HPP: Rp 60 juta/bulan
...
Bandingkan dengan bulan lalu, dan bulan yang sama tahun lalu.

**Yang harus dicek:**

1. **Penjualan naik/turun?**
   - Naik: Cari tahu penyebab (marketing sukses? Promo berhasil?)
   - Turun: Cari tahu masalah (musim sepi? Kompetitor baru?)

2. **Pengeluaran naik/turun?**
   - Naik: Ada biaya tidak terduga? Atau memang ekspansi?
   - Turun: Efisiensi? Atau ada yang dikurangi sampai bikin masalah?

3. **Laba naik/turun?**
   - Naik: Pertahankan strategi.
   - Turun: Cari tahu akarnya. Jangan cuma lihat "laba turun", tapi "apa yang bikin turun".

Saya coba sendiri: Bulan Maret penjualan turun 20%.
